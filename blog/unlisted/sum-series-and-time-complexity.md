...
As I dove into all this, I worked out a simple series sum for the fun of it. [Nid](https://bsky.app/profile/nid90.bsky.social) and I worked out an algebraic expansion that's much more symmetric than blindly applying the [Gauss pairing trick](https://en.wikipedia.org/wiki/Gauss_sum), which every LLM appears to want you to do.
...
None of this stuff is new of course, and my previously tacit understanding of much of this isn't inherently bad either. Even though I started off analysing snippets of code with the help of LLMs, I gave up and moved on to using it purely in a pedagogy mode and finding connections that I never knew existed.
